<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prorep.aspx.cs" Inherits="home" %>
                                            ...
                                            <tr>
                                                <td align="left" width="250px">
                                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                        ...
                                                        SelectCommand="select pid,name,pamount,qty from tblproduct">
                                                    </asp:SqlDataSource>
                                                </td>
                                                ...
                                                <td align="center" colspan="4">
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="name" HeaderText="Name" SortExpression="fn">
                                                                <ItemStyle Width="150px" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="pamount" HeaderText="Amount" SortExpression="mobile">
                                                                <ItemStyle Width="150px" />
                                                            </asp:BoundField>
