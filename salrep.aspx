<%@ Page Language="C#" AutoEventWireup="true" CodeFile="salrep.aspx.cs" Inherits="home" %>
                                            ...
                                            <tr>
                                                <td align="left" width="250px">
                                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                        ...
                                                        SelectCommand="select cname,pname,price from tblsales">
                                                    </asp:SqlDataSource>
                                                </td>
                                                ...
                                                <td align="center" colspan="4">
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="pname" HeaderText="Product Name" SortExpression="bid">
                                                                <ItemStyle Width="150px" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="price" HeaderText="Price" SortExpression="mobile">
                                                                <ItemStyle Width="150px" />
                                                            </asp:BoundField>
