<%@ Page Language="C#" AutoEventWireup="true" CodeFile="caward.aspx.cs" Inherits="home" %>
            ...
            <tr  >
                <td align="center">
                    <table align="center" cellpadding="0" cellspacing="0" class="style4">
                        <tr>
                            <td colspan="2">
                                <img alt="" src="images/awt.jpg" style="width: 1300px; height: 220px" /></td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                        &nbsp;</td>
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                        <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" 
                                            AutoDataBind="True" DisplayGroupTree="False" Height="777px" 
                                            ReportSourceID="CrystalReportSource1" Width="1080px" />
                                        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                                            <report filename="awardreport.rpt">
                                            </report>
